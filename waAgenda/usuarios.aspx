...
<asp:SqlDataSource ID="SqlDataSourceUsuarios" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [Usuarios] WHERE [email] = @email" InsertCommand="INSERT INTO [Usuarios] ([email], [nome], [senha]) VALUES (@email, @nome, @senha)" SelectCommand="SELECT [email], [nome], [senha] FROM [Usuarios]" UpdateCommand="UPDATE [Usuarios] SET [nome] = @nome, [senha] = @senha WHERE [email] = @email" OnInserted="SqlDataSourceUsuarios_Inserted" OnInserting="SqlDataSourceUsuarios_Inserting" OnUpdated="SqlDataSourceUsuarios_Updated">
    <DeleteParameters>
